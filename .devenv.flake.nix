{
  ...
  version = "1.11.2";
  system = "x86_64-linux";
  devenv_root = "/home/irrelevancy/pc-software";
  project_input_ref = "path:/home/irrelevancy/pc-software";
  devenv_dotfile = "/home/irrelevancy/pc-software/.devenv";
  devenv_dotfile_path = ./.devenv;
  devenv_tmpdir = "/run/user/1000";
  devenv_runtime = "/run/user/1000/devenv-8341cfa";
